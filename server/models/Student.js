...
const studentSchema = new mongoose.Schema({
  ...
  email: { type: String, required: true, unique: true, index: true }, // e.g. student@gmail.com
  ...
  loginApproval: { type: String, enum: ["Approved", "Pending", "Preview", "Rejected"], default: "Pending" },
  portalAccessMode: { type: String, default: "Pending Approval" },
